	...
	<div class="login-wrapper">
		<el-dialog
			...
			<el-form :model="data" :rules="rules" ref="searchForm">
				...
				<el-form-item label="密码" label-width="120px" prop="checkPassword">
					<el-input v-model="data.checkPassword" placeholder="请再次输入密码" type="password" clearable></el-input>
				</el-form-item>
				<el-form-item >
  ...
  export default {
    ...
    data() {
      var checkPass = (rule, value, callback) => {
        ...
        else if (value !== this.data.userPassword) {
